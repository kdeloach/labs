...
public class Yahtzee extends JPanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if(e.getActionCommand().equals(SELECT) && choices.getSelectedItem() != null)
        {
            ...
            {
                if(scorecard.points[id].getText().equals(""))
                {
                ...
                {
                    int bonus = 0;
                    if(!scorecard.bonusBottom.getText().equals(""))
                    {
            ...
            else if(scorecard.points[id].getText().equals(""))
            {
                scorecard.points[id].setText(new Integer(score).toString());
            }
    ...
    public static JMenuBar createJMenuBar()
    {
        ...
        menuItem = new JMenuItem("Score Sheet");
        menu.add(menuItem);
        menuBar.add(menu);
